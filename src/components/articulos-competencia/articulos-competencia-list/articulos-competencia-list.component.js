        ...
        axios.get(URL).then((res) => {
            ...
            res.data.forEach((competencia) => {
                exportados.push({
                    ...
                    CodigoArticuloCompetencia: competencia.articuloCompetencia ? competencia.articuloCompetencia.codigo : '',
                    DescripcionArticuloCompetencia: competencia.articuloCompetencia ? competencia.articuloCompetencia.descripcion : '',
