    ...
    return (
        <div className="list__item">
            <div className="list__item-header">
                <h6 className="list__item-title">{`${formatDate()} - ${pedido.user && pedido.user.email || ''} - ${pedido.sucursal && pedido.sucursal.calle} ${pedido.sucursal && pedido.sucursal.altura} ${pedido.sucursal && pedido.sucursal.localidad}`}</h6>
